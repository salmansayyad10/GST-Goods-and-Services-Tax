<%@ page language="C#" autoeventwireup="true" inherits="hno, App_Web_t0jkv0nh" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">

    <title>Goods & Services Tax (GST) | Home/Plot Number/Name</title>
...
<section class="post-wrapper-top">
    <div class="container">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcrumb">
          ...
          <li><a href="hno.aspx">Home/Plot Number/Name</a></li>
         
        </ul>
        <h2>Home/Plot Number/Name</h2>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
         </div>
    </div>
  ...
  <u style=text-transform:capitalize;"><asp:Label ID="Label2" runat="server"></asp:Label></u>
    ...
    <div class="form-group">
        <asp:TextBox ID="t2" runat="server" class="form-control" placeholder="Home/Plot Number/Name" pattern="{3,25}" required="" title="Enter Your Home/Plot Number/Name" oninvalid="this.setCustomValidity('Please Enter Valid Home/Plot Number/Name')"></asp:TextBox>
