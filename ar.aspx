<%@ page language="C#" autoeventwireup="true" inherits="ar, App_Web_t0jkv0nh" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Goods & Services Tax (GST) | Area Name/Number</title>
...
<section class="post-wrapper-top">
    <div class="container">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcrumb">
          ...
          <li><a href="ar.aspx">Area Name/Number</a></li>
         
        </ul>
        <h2>Area Name/Number</h2>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
         </div>
    </div>
  ...
  <u style=text-transform:capitalize;"><asp:Label ID="Label2" runat="server"></asp:Label></u>
    ...
    <div class="form-group">
        <asp:TextBox ID="t2" runat="server" class="form-control" placeholder="Area Name/Number" pattern="{3,25}" required="" title="Enter Your Area Name/Number" oninvalid="this.setCustomValidity('Please Enter Valid Area Name/Number')"></asp:TextBox>
