<%@ page language="C#" autoeventwireup="true" inherits="dob, App_Web_t0jkv0nh" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">

    <title>Goods & Services Tax (GST) | Birth Date</title>
...
<section class="post-wrapper-top">
    <div class="container">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcrumb">
          ...
          <li><a href="dob.aspx">Birth Date</a></li>
  ...
  <u style=text-transform:capitalize;"><asp:Label ID="Label2" runat="server"></asp:Label></u>
    ...
    <div class="form-group">
        <asp:TextBox ID="t2" runat="server" type="date" class="form-control" placeholder="Birth Date" required="" title="Enter Your PAN Card" oninvalid="this.setCustomValidity('Please Enter Valid Birth Date')"></asp:TextBox>
